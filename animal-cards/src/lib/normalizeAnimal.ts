...
const overrides: Record<string, Override> = {
  ...
  elephant: { funFacts: ["Elephants are the largest land animals!", "Elephants can recognize themselves in mirrors.", "Baby elephants can stand within 20 minutes of birth."], conservationStatus: "Endangered" },
  ...
  penguin: { funFacts: ["Penguins are birds that cannot fly!", "Emperor penguins dive deeper than any other bird.", "Penguins huddle together to stay warm."], conservationStatus: "Least Concern" },
  dolphin: { funFacts: ["Dolphins sleep with one eye open!", "Dolphins call each other by name using whistles.", "A group of dolphins is called a pod."], conservationStatus: "Least Concern" },
  ...
  gorilla: { funFacts: ["Gorillas can learn sign language!", "Gorillas build a new nest every night.", "Gorilla DNA is 98% the same as humans."], conservationStatus: "Critically Endangered" },
...
export function normalizeAnimal(
  ...
  return {
    ...
    binomialName: raw.scientific_name ?? '',
    habitat: raw.habitat ?? '',
